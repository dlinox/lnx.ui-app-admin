...
const items = ref<CurriculumDTO[]>([]);
const showModal = ref<boolean>(false);
const editItem = ref<CurriculumDTO | null>(null);
...
const response = ref<DataTableResponseDTO<CurriculumDTO>>(
  {} as DataTableResponseDTO<CurriculumDTO>
);

const openFormModal = (item: CurriculumDTO | null) => {
  editItem.value = item;
  showModal.value = true;
};

const deleteItem = async (item: CurriculumDTO) => {
