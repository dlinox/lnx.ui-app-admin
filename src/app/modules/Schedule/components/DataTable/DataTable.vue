...
import type { ScheduleDTO } from "@/app/modules/Schedule/types/Schedule.types";

import {
  _createColumns,
  _createPagination,
} from "@/app/modules/Schedule/configs/dataTable.configs";
...
import ScheduleForm from "@/app/modules/Schedule/components/ScheduleForm.vue";

const loadingTable = ref(false);
const items = ref<ScheduleDTO[]>([]);
const showModal = ref<boolean>(false);
const editItem = ref<ScheduleDTO | null>(null);
...
const response = ref<DataTableResponseDTO<ScheduleDTO>>(
  {} as DataTableResponseDTO<ScheduleDTO>
);

const openFormModal = (item: ScheduleDTO | null) => {
  editItem.value = item;
  showModal.value = true;
};

const deleteItem = async (item: ScheduleDTO) => {
