...
import DataTableOp from "@/app/modules/Schedule/components/DataTable/DataTableOp.vue";

export const _createColumns = (
  openModal: (item: ScheduleDTO) => void,
  deleteItem: (item: ScheduleDTO) => void
): DataTableColumns => [
  {
    title: "Ops.",
    key: "ops",
    ...
    fixed: "left",
    render(rowData: any) {
      const rowItem = rowData as ScheduleDTO;
      return h(
        DataTableOp,
        {
          onEdit: () => {
