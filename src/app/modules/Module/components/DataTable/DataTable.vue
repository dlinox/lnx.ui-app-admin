...
import {
  _createColumns,
  _createPagination,
} from "@/app/modules/Module/configs/dataTable.configs";
...
const response = ref<DataTableResponseDTO<ModuleDTO>>(
  {} as DataTableResponseDTO<ModuleDTO>
);

const openFormModal = (item: ModuleDTO | null) => {
  editItem.value = item;
  showModal.value = true;
};

const deleteItem = async (item: ModuleDTO) => {
