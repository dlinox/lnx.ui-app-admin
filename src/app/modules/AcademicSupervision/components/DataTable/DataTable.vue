...
import {
  _createColumns,
  _createPagination,
} from "@/app/modules/AcademicSupervision/components/DataTable/configs";

import { _loadDataTable, _deleteItem } from "@/app/modules/AcademicSupervision/services/academicSupervision.services";
...
const items = ref<AcademicSupervisionDTO[]>([]);
...
const response = ref<DataTableResponseDTO<AcademicSupervisionDTO>>(
  {} as DataTableResponseDTO<AcademicSupervisionDTO>
);

const openFormModal = (item: AcademicSupervisionDTO | null) => {
  editItem.value = item;
  showModal.value = true;
};

const deleteItem = async (item: AcademicSupervisionDTO) => {
