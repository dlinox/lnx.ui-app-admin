...
import DataTableOp from "@/app/modules/ModulePrice/components/DataTable/DataTableOp.vue";

export const _createColumns = (
  openModal: (item: ModulePriceDataTableItemDTO) => void,
  deleteItem: (item: ModulePriceDataTableItemDTO) => void
): DataTableColumns => [
  {
    title: "Ops.",
    key: "ops",
    ...
    fixed: "left",
    render(rowData: any) {
      const rowItem = rowData as ModulePriceDataTableItemDTO;
      return h(
        DataTableOp,
        {
          onEdit: () => {
