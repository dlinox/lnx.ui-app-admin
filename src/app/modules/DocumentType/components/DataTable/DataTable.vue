...
import {
  _createColumns,
  _createPagination,
} from "@/app/modules/DocumentType/configs/dataTable.configs";
...
const items = ref<DocumentTypeDTO[]>([]);
const showModal = ref<boolean>(false);
const editItem = ref<DocumentTypeDTO | null>(null);
...
const response = ref<DataTableResponseDTO<DocumentTypeDTO>>(
  {} as DataTableResponseDTO<DocumentTypeDTO>
);

const openFormModal = (item: DocumentTypeDTO | null) => {
  editItem.value = item;
  showModal.value = true;
};

const deleteItem = async (item: DocumentTypeDTO) => {
