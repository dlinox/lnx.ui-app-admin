...
import {
  _createColumns,
  _createPagination,
} from "@/app/modules/SessionTime/configs/dataTable.configs";
...
import SessionTimeForm from "@/app/modules/SessionTime/components/SessionTimeForm.vue";

const loadingTable = ref(false);
const items = ref<SessionTimeDTO[]>([]);
const showModal = ref<boolean>(false);
const editItem = ref<SessionTimeDTO | null>(null);
...
const response = ref<DataTableResponseDTO<SessionTimeDTO>>(
  {} as DataTableResponseDTO<SessionTimeDTO>
);

const openFormModal = (item: SessionTimeDTO | null) => {
  editItem.value = item;
  showModal.value = true;
};

const deleteItem = async (item: SessionTimeDTO) => {
