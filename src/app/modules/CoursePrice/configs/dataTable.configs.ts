...
import DataTableOp from "@/app/modules/CoursePrice/components/DataTable/DataTableOp.vue";

export const _createColumns = (
  openModal: (item: CoursePriceDataTableItemDTO) => void,
  deleteItem: (item: CoursePriceDataTableItemDTO) => void
): DataTableColumns => [
  {
    title: "Ops.",
    key: "ops",
    ...
    fixed: "left",
    render(rowData: any) {
      const rowItem = rowData as CoursePriceDataTableItemDTO;
      return h(
        DataTableOp,
        {
          onEdit: () => {
