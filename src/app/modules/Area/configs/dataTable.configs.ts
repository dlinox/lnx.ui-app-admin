...
import DataTableOp from "@/app/modules/Area/components/DataTable/DataTableOp.vue";
import {
...
export const _createColumns = (
  openModal: (item: AreaDTO) => void,
  deleteItem: (item: AreaDTO) => void
): DataTableColumns => [
  {
    title: "Ops.",
    key: "ops",
    ...
    fixed: "left",
    render(rowData: any) {
      const rowItem = rowData as AreaDTO;
      return h(
        DataTableOp,
        {
          onEdit: () => {
