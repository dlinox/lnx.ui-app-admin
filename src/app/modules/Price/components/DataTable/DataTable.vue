...
import { type PriceDataTableItemDTO } from "@/app/modules/Price/types/Price.types";
...
import {
  _createColumns,
  _createPagination,
} from "@/app/modules/Price/configs/dataTable.configs";
...
import {
  _loadDataTable,
  _deleteItem,
} from "@/app/modules/Price/services/price.services";

import debounce from "@/core/utils/debounce.utils";
import LnxIcon from "@/core/components/LnxIcon.vue";

import type { PriceDataTablePropsDTO } from "../../types/Price.types";
...
const props = defineProps<PriceDataTablePropsDTO>();
...
const items = ref<PriceDataTableItemDTO[]>([]);
const showModal = ref<boolean>(false);
const editItem = ref<PriceDataTableItemDTO | null>(null);
...
const response = ref<DataTableResponseDTO<PriceDataTableItemDTO>>(
  {} as DataTableResponseDTO<PriceDataTableItemDTO>
);

const openFormModal = (item: PriceDataTableItemDTO | null) => {
  editItem.value = item;
  showModal.value = true;
};

const deleteItem = async (item: PriceDataTableItemDTO) => {
