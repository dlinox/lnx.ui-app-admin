import{a as D,O as m,x as p,z as s,ca as H,cb as M,A as v,B as n,Q as B,d as u,h as t,u as E,f as O,G as f,p as I,H as L,e as K,K as S,i as T,ba as V}from"./index-CTX32WvQ.js";function A(o){const{textColor2:r,cardColor:e,modalColor:l,popoverColor:d,dividerColor:a,borderRadius:b,fontSize:i,hoverColor:c}=o;return{textColor:r,color:e,colorHover:c,colorModal:l,colorHoverModal:m(l,c),colorPopover:d,colorHoverPopover:m(d,c),borderColor:a,borderColorModal:m(l,a),borderColorPopover:m(d,a),borderRadius:b,fontSize:i}}const G={common:D,self:A},Q=p([s("list",`
