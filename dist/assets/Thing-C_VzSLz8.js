import{a as $,N as b,x as h,z as l,A as m,B as d,aG as T,aH as B,d as C,u as z,f as w,D as x,p as H,G as M,e as y,I as R,h as t,P as L,i as V,aV as F,Z as W}from"./index-Bqe-vxMq.js";function G(r){const{textColor2:e,cardColor:n,modalColor:i,popoverColor:c,dividerColor:v,borderRadius:u,fontSize:s,hoverColor:a}=r;return{textColor:e,color:n,colorHover:a,colorModal:i,colorHoverModal:b(i,a),colorPopover:c,colorHoverPopover:b(c,a),borderColor:v,borderColorModal:b(i,v),borderColorPopover:b(c,v),borderRadius:u,fontSize:s}}const K={name:"List",common:$,self:G};function A(r){const{textColor1:e,textColor2:n,fontWeightStrong:i,fontSize:c}=r;return{fontSize:c,titleTextColor:e,textColor:n,titleFontWeight:i}}const N={name:"Thing",common:$,self:A},Z=h([l("list",`
