import{a as $,O as b,x as h,z as l,A as m,B as d,aP as T,aQ as B,d as C,u as z,f as w,D as x,p as H,G as M,e as y,I as R,h as t,Q as L,i as V,ar as F,_ as W}from"./index-BzGjg7HW.js";function K(r){const{textColor2:e,cardColor:n,modalColor:i,popoverColor:c,dividerColor:v,borderRadius:u,fontSize:s,hoverColor:a}=r;return{textColor:e,color:n,colorHover:a,colorModal:i,colorHoverModal:b(i,a),colorPopover:c,colorHoverPopover:b(c,a),borderColor:v,borderColorModal:b(i,v),borderColorPopover:b(c,v),borderRadius:u,fontSize:s}}const Q={name:"List",common:$,self:K};function A(r){const{textColor1:e,textColor2:n,fontWeightStrong:i,fontSize:c}=r;return{fontSize:c,titleTextColor:e,textColor:n,titleFontWeight:i}}const G={name:"Thing",common:$,self:A},q=h([l("list",`
