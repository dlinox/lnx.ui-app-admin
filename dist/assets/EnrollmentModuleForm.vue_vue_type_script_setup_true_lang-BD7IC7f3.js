import{d as B,h as f,a as Y,z as x,A as P,B as g,x as p,W as ce,V as ae,u as H,r as F,e as N,D as L,p as ue,f as q,I as ee,Q as pe,M as W,aJ as me,G as se,n as fe,v as ge,a0 as be,a1 as ve,Z as he,i as xe,aK as Ce,ar as oe,U as _e,aL as ye,O as T,aC as U,aM as we,aN as ze,aw as J,g as Se,a9 as Pe,aa as Q,al as X,ab as w,a8 as k,ad as z,ah as te,_ as re,aH as Ie,ao as O,af as Re,ai as $e,aj as Ne,ac as Ee}from"./index-BOXL2TiF.js";import{u as Te}from"./get-DOtZouVG.js";import{h as le}from"./DataTable.types-B90ErchY.js";import{C as ke}from"./Dropdown-d17eZhwV.js";import{e as Me,f as Ve,g as Fe}from"./EditEnrollmentGroup.vue_vue_type_script_setup_true_lang-D4iCyvFi.js";import{r as Ae}from"./icon.utils-BQfYQcDe.js";import{_ as Be}from"./Select-Biy6SjtC.js";import{_ as De,a as Le}from"./FormItem-C4wDlZap.js";import{_ as Oe,a as je}from"./Col-BTffZrwQ.js";const We=B({name:"ChevronLeft",render(){return f("svg",{viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},f("path",{d:"M10.3536 3.14645C10.5488 3.34171 10.5488 3.65829 10.3536 3.85355L6.20711 8L10.3536 12.1464C10.5488 12.3417 10.5488 12.6583 10.3536 12.8536C10.1583 13.0488 9.84171 13.0488 9.64645 12.8536L5.14645 8.35355C4.95118 8.15829 4.95118 7.84171 5.14645 7.64645L9.64645 3.14645C9.84171 2.95118 10.1583 2.95118 10.3536 3.14645Z",fill:"currentColor"}))}});function Ue(e){const{fontWeight:o,textColor1:a,textColor2:t,textColorDisabled:s,dividerColor:r,fontSize:l}=e;return{titleFontSize:l,titleFontWeight:o,dividerColor:r,titleTextColor:a,titleTextColorDisabled:s,fontSize:l,textColor:t,arrowColor:t,arrowColorDisabled:s,itemMargin:"16px 0 0 0",titlePadding:"16px 0 0 0"}}const He={name:"Collapse",common:Y,self:Ue},qe=x("collapse","width: 100%;",[x("collapse-item",`
 ...
 `),p("td",`
 background-color: var(--n-td-color-popover);
 `)]))]),lo=Object.assign(Object.assign({},L.props),{bordered:{type:Boolean,default:!0},bottomBordered:{type:Boolean,default:!0},singleLine:{type:Boolean,default:!0},striped:Boolean,singleColumn:Boolean,size:{type:String,default:"medium"}}),Ro=B({name:"Table",props:lo,setup(e){const{mergedClsPrefixRef:o,inlineThemeDisabled:a,mergedRtlRef:t}=H(e),s=L("Table","-table",ro,eo,e,o),r=q("Table",t,o),l=N(()=>{const{size:h}=e,{self:{borderColor:v,tdColor:c,tdColorModal:n,tdColorPopover:b,thColor:S,thColorModal:_,thColorPopover:C,thTextColor:m,tdTextColor:y,borderRadius:$,thFontWeight:M,lineHeight:i,borderColorModal:d,borderColorPopover:I,tdColorStriped:V,tdColorStripedModal:E,tdColorStripedPopover:A,[J("fontSize",h)]:D,[J("tdPadding",h)]:K,[J("thPadding",h)]:G},common:{cubicBezierEaseInOut:Z}}=s.value;return{"--n-bezier":Z,"--n-td-color":c,"--n-td-color-modal":n,"--n-td-color-popover":b,"--n-td-text-color":y,"--n-border-color":v,"--n-border-color-modal":d,"--n-border-color-popover":I,"--n-border-radius":$,"--n-font-size":D,"--n-th-color":S,"--n-th-color-modal":_,"--n-th-color-popover":C,"--n-th-font-weight":M,"--n-th-text-color":m,"--n-line-height":i,"--n-td-padding":K,"--n-th-padding":G,"--n-td-color-striped":V,"--n-td-color-striped-modal":E,"--n-td-color-striped-popover":A}}),u=a?ee("table",N(()=>e.size[0]),l,e):void 0;return{rtlEnabled:r,mergedClsPrefix:o,cssVars:a?void 0:l,themeClass:u==null?void 0:u.themeClass,onRender:u==null?void 0:u.onRender}},render(){var e;const{mergedClsPrefix:o}=this;return(e=this.onRender)===null||e===void 0||e.call(this),f("table",{class:[`${o}-table`,this.themeClass,{[`${o}-table--rtl`]:this.rtlEnabled,[`${o}-table--bottom-bordered`]:this.bottomBordered,[`${o}-table--bordered`]:this.bordered,[`${o}-table--single-line`]:this.singleLine,[`${o}-table--single-column`]:this.singleColumn,[`${o}-table--striped`]:this.striped}],style:this.cssVars},this.$slots)}}),ne=()=>({studentId:null,curriculumId:null,moduleId:null,payments:[]}),no=()=>({studentId:[],curriculumId:[],moduleId:[{type:"number",required:!0,trigger:["blur","input"],message:"Obligatorio"}]}),ao={class:"table-auto w-full"},so={class:"px-4 py-2 flex items-center"},io={class:"ms-2"},co={class:"text-end px-4 py-2"},uo={class:"border-b-2 border-gray-500"},po={class:"px-4 py-2 font-bold text-lg text-end"},mo={class:"px-4 py-2 font-bold text-lg text-end"},fo={class:"text-red-500 text-sm text-end text-sm"},$o=B({__name:"EnrollmentModuleForm",props:{modelValue:{type:Boolean},studentId:{},curriculumId:{}},emits:["update:modelValue","success"],setup(e,{emit:o}){const a=o,t=e,s=N({get:()=>t.modelValue,set:i=>a("update:modelValue",i)}),r=F(!1),l=F(!1),u=F([]),h=F(null),v=N(()=>no()),c=F(ne()),n=F([]),b=F(0),S=i=>{console.log("Pago validado",i),c.value.payments.push(i.token),n.value.push({token:i.token,amount:i.payment.amount,sequenceNumber:i.payment.sequenceNumber})},_=i=>{let I=n.value[i].token;n.value.splice(i,1);let V=c.value.payments.find(A=>A.token==I);if(!V)return;let E=c.value.payments.indexOf(V);c.value.payments.splice(E,1)},C=i=>{console.log("Seleccionando modulo",i),c.value.payments=[],u.value.forEach(d=>{d.value==i&&(b.value=d.price)})},m=async()=>{const i=await Fe(t.studentId,t.curriculumId);u.value=i.data},y=()=>n.value.reduce((d,I)=>d+parseInt(I.amount),0)>=b.value?null:"El monto pagado es menor al total",$=async()=>{c.value.studentId=t.studentId,c.value.curriculumId=t.curriculumId,r.value=!0,(await Ve(c.value)).status&&(a("success"),s.value=!1),r.value=!1,console.log("Guardando matricula",c.value)},M=()=>{m(),console.log("Inicializando formulario")};return Se(s,i=>{i&&(c.value=Object.assign({},{...ne()}),n.value=[],M())}),(i,d)=>{const I=Be,V=De,E=Oe,A=Pe("LnxIcon"),D=Re,K=je,G=Le,Z=$e,de=Ne;return Q(),X(re,null,[w(de,{show:s.value,"onUpdate:show":d[2]||(d[2]=R=>s.value=R)},{default:k(()=>[w(Z,{style:{width:"600px"},title:"MATRICULA EN MODULO",segmented:{content:!0,footer:!0},size:"small",role:"dialog","aria-modal":"true"},{default:k(()=>[w(G,{ref_key:"formRef",ref:h,model:c.value,rules:v.value,size:"large"},{default:k(()=>[w(K,{gutter:[16,16]},{default:k(()=>[w(E,{span:"24"},{default:k(()=>[w(V,{path:"moduleId",label:"Modulo"},{default:k(()=>[w(I,{value:c.value.moduleId,"onUpdate:value":[d[0]||(d[0]=R=>c.value.moduleId=R),C],placeholder:"Seleccionar modulo",options:u.value,"virtual-scroll":!1,clearable:"",filterable:""},null,8,["value","options"])]),_:1})]),_:1}),w(E,{span:"24"},{default:k(()=>[z("span",{role:"button",onClick:d[1]||(d[1]=R=>l.value=!0),class:"border border-dashed border-gray-300 p-4 rounded-sm flex items-center justify-center cursor-pointer text-gray-400 hover:bg-gray-50 font-bold hover:text-gray-500 mb-4"},[w(A,{class:"me-3","icon-name":"money-add",size:"20"}),d[4]||(d[4]=te(" Agregar pago "))]),z("table",ao,[z("tbody",null,[(Q(!0),X(re,null,Ie(n.value,(R,j)=>(Q(),X("tr",{key:j,class:"border-b border-gray-300 border-dashed px-4 py-2"},[z("td",so,[w(D,{type:"error",size:"small",secondary:"",onClick:go=>_(j),"render-icon":Ee(Ae)("trash")},null,8,["onClick","render-icon"]),z("i",io,O(R.sequenceNumber),1)]),z("td",co,"S/. "+O(R.amount),1)]))),128)),z("tr",uo,[d[5]||(d[5]=z("td",{class:"px-4 py-2"},"Total pagado",-1)),z("td",po," S/. "+O(n.value.reduce((R,j)=>R+parseInt(j.amount),0)),1)]),z("tr",null,[d[6]||(d[6]=z("td",{class:"px-4 py-2"},"Total a pagar",-1)),z("td",mo," S/. "+O(b.value),1)])])]),z("div",fo,O(y()),1)]),_:1}),w(E,{span:"24"},{default:k(()=>[w(D,{size:"large",type:"primary",onClick:$,block:"",loading:r.value},{default:k(()=>d[7]||(d[7]=[te(" Realizar matricula ")])),_:1},8,["loading"])]),_:1})]),_:1})]),_:1},8,["model","rules"])]),_:1})]),_:1},8,["show"]),w(Me,{modelValue:l.value,"onUpdate:modelValue":d[3]||(d[3]=R=>l.value=R),studentId:t.studentId,onSuccess:S},null,8,["modelValue","studentId"])],64)}}});export{$o as _,Io as a,So as b,Ro as c,Po as d};
