import{a as $,O as b,x as h,z as l,A as m,B as d,aM as T,aN as B,d as C,u as z,f as w,D as x,p as M,G as H,e as y,I as R,h as t,Q as L,i as V,aK as F,_ as K}from"./index-BDy3jz-R.js";function W(r){const{textColor2:e,cardColor:n,modalColor:i,popoverColor:c,dividerColor:v,borderRadius:u,fontSize:s,hoverColor:a}=r;return{textColor:e,color:n,colorHover:a,colorModal:i,colorHoverModal:b(i,a),colorPopover:c,colorHoverPopover:b(c,a),borderColor:v,borderColorModal:b(i,v),borderColorPopover:b(c,v),borderRadius:u,fontSize:s}}const A={name:"List",common:$,self:W};function G(r){const{textColor1:e,textColor2:n,fontWeightStrong:i,fontSize:c}=r;return{fontSize:c,titleTextColor:e,textColor:n,titleFontWeight:i}}const N={name:"Thing",common:$,self:G},Q=h([l("list",`
